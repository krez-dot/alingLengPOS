<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="/index.php">Sari-Sari POS</a>
        ...
        <div class="collapse navbar-collapse" id="navMenu">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/pos/index.php">New Sale (POS)</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="/sales/index.php">Sales History</a></li>
            </ul>
        </div>
    </div>
</nav>
