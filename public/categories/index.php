    ...
    <tbody>
        ...
        <?php foreach ($categories as $cat): ?>
            <tr>
                ...
                <td>
                    <a href="<?= BASE_URL ?>/categories/edit.php?id=<?= $cat['id'] ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                    <form action="<?= BASE_URL ?>/categories/delete.php" method="post" class="d-inline" onsubmit="return confirm('Delete this category?');">
